                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1 text-left">
                          ...
                          {member.mobile_no ? (
                            <a href={`tel:${member.mobile_no}`} className="text-green-700 hover:text-green-800 underline-offset-2 hover:underline text-left">
                              {member.mobile_no}
                            </a>
                          ) : (
                            <p className="text-gray-600 text-left">Not available</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="min-w-0 flex-1 text-left">
                          ...
                          {member.work_phone ? (
                            <a href={`tel:${member.work_phone}`} className="text-green-700 hover:text-green-800 underline-offset-2 hover:underline text-left">
                              {member.work_phone}
                            </a>
                          ) : (
                            <p className="text-gray-600 text-left">Not available</p>
